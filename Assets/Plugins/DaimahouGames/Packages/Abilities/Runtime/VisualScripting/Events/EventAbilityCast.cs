...
//
//             m_Disposable = caster.ObserveFailedCast().Subscribe(OnCastFailed);
//         }
//
...
//         }
//
//         private void OnCastFailed(string message)
//         {
//             SetMessage(message);
//             m_Trigger.Execute(m_Args);
//         }
//
//         private void SetMessage(string message)
//         {
//             (m_Args ??= new ExtendedArgs(m_Caster.Get(Args.EMPTY))).Set(message);
//         }
//         
//         //============================================================================================================||
//     }
