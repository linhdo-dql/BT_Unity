...
namespace DaimahouGames.Editor.Abilities
{
    ...
    public class ProjectileInspector: UnityEditor.Editor
    {
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            m_HomingSettings.SetIcon(new Runtime.Abilities.IconAimTarget(ColorTheme.Type.Blue));
        ...
        {
            var prefabProperty = serializedObject.FindProperty("m_Prefab")?.GetValue<PropertyGetGameObject>();
        ...
        private void SetHomingTitle()
        {
            ...
            var homing = homingField.GetValue<bool>();
            var latency = precisionField.GetValue<float>();
